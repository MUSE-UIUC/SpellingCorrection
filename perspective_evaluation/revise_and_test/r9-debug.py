                ...
                for i in range(0,len(All_Sentences_Scores[k])):
                    ...
                    try:
                        ...
                        for j in range(len(All_Sentences_Scores[k][i][5])):
                            ...
                            if (str(All_Sentences_Scores[k][i][5][j]) == ''):
                                print('\nbug: new word is empty')
                                print('original word:', All_Sentences_Scores[k][i][4])
                                print('new word:', All_Sentences_Scores[k][i][5][j])
                                print('method:', k)
                                print('(original_sentence, original_score, revised_sentence, revised_toxic_score, revised_word, new_word):')
                                print(All_Sentences_Scores[k][i])
                                print('')
                        temp.write('\n\n')   
                    except:
