...
for i in range(3600,len(selected_inds)):
    All_Sentences_Scores = revise_sentence_and_test_list_5_ways_invalid(selected_inds[i:i+1], selected_words[i:i+1], tok_sent[i:i+1], Folder_List, str(361)+'_')
    #print(len(All_Sentences_Scores))
