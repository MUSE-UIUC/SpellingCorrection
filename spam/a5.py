...
with open(pickle_output_file_path_prefix+'Original_and_Modified_Content_List5.pickle', "wb") as handle:
    pickle.dump(Original_and_Modified_Content_List, handle)
with open(pickle_output_file_path_prefix+'Correct_and_Wrong_Words_List5.pickle', "wb") as handle:
